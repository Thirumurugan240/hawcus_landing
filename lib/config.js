...
export const GOOGLE_OAUTH = {
  clientId: process.env.GOOGLE_OAUTH_CLIENT_ID || process.env.GSC_OAUTH_CLIENT_ID || "",
  clientSecret: process.env.GOOGLE_OAUTH_CLIENT_SECRET || process.env.GSC_OAUTH_CLIENT_SECRET || "",
  scopes: (process.env.GOOGLE_OAUTH_SCOPES || "https://www.googleapis.com/auth/webmasters.readonly https://www.googleapis.com/auth/analytics.readonly").trim(),
};

export const GOOGLE_OAUTH_READY = Boolean(GOOGLE_OAUTH.clientId && GOOGLE_OAUTH.clientSecret);
